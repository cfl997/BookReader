...
void DialogConfig::init()
{
    ...
    frontColor.setAlpha(fontAlpha);
    backColor = w->paintInfo.background.color();
    backColor.setAlpha(backAlpha);
    ...
    olFrontColor.setRgb(fontr, fontg, fontb,fontAlpha);
    olBackColor.setRgb(bgr, bgg, bgb,backAlpha);
...
{
    frontColor.setRgb(DEFAULTFONTR, DEFAULTFONTG, DEFAULTFONTB,fontAlpha);
    backColor.setRgb(DEFAULTBGR, DEFAULTBGG, DEFAULTBGB,backAlpha);
    ...
    olFrontColor.setRgb(ONELINE_FONTR, ONELINE_FONTG, ONELINE_FONTB,fontAlpha);
    olBackColor.setRgb(ONELINE_BGR, ONELINE_BGG, ONELINE_BGB,backAlpha);
...
void DialogConfig::on_pushButtonOLFront_clicked()
{
    ...
    if (c.isValid())
    {
        ...
        olFrontColor = c;
        olFrontColor.setAlpha(fontAlpha);
    }
}
...
void DialogConfig::on_pushButtonOLBack_clicked()
{
    ...
    {
        olBackColor = c;
        olBackColor.setAlpha(backAlpha);
    }
}
