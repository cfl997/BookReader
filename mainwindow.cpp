...
void MainWindow::init2()
{
    ...
    {
    hotKeyRead = new QHotkey(QKeySequence(Qt::CTRL+ Qt::SHIFT + Qt::Key_T), true, QApplication::instance());
    if (hotKeyRead->isRegistered())
        connect(hotKeyRead, &QHotkey::activated, this, &MainWindow::handleHotKeyHide);
    else
        QMessageBox::warning(this, tr("错误"), tr("注册热键Ctrl+shift+T失败。"));
    }
}
...
void MainWindow::handleHotKeyHide()
{
